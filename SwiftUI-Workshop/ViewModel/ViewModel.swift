...
class MockBookService: BookService {
    // MARK: Mock data
    var books: [Book] = [
        Book(id: 1, title: "The Fellowship of the Ring", author: "J. R. R. Tolkien", price: 18.85, imageName: "fellow"),
        Book(id: 2, title: "The Two Towers", author: "J. R. R. Tolkien", price: 11.99, imageName: "twoTowers"),
        Book(id: 3, title: "Homo Deus: A Brief History of Tomorrow", author: "Yuval Noah Harari", price: 19.99, imageName: "homoDeus"),
        Book(id: 4, title: "The 4-Hour Workweek", author: "Timothy Ferriss", price: 16.15, imageName: "the4Hours"),
        Book(id: 5, title: "Man's Search for Meaning", author: "Viktor E. Frankl", price: 12.25, imageName: "manSearch"),
        Book(id: 6, title: "The Odyssey", author: "Homer", price: 10.99, imageName: "odyssey"),
        Book(id: 7, title: "Artificial Intelligence: A Modern Approach", author: "Stuart J. Rossell", price: 22.99, imageName: "ai"),
        Book(id: 8, title: "Creativity, Inc.", author: "Ed Catmull", price: 17.85, imageName: "creativity"),
